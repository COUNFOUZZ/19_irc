...
#define RPL_CHANNELMODEIS(nickname, channel, modes) (std::string("324 ") + nickname + " "+ channel + " " + modes + "\r\n")
#define RPL_NOTOPIC(nickname, channel) (std::string("331 ") + nickname + " " + channel + " No topic set for channel " + channel + "\r\n")
#define RPL_TOPIC(nickname, channel, topic) (std::string("332 ") + nickname + " " + channel + " :" + topic + "\r\n")
